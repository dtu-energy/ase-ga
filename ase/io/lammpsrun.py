...
def lammps_data_to_ase_atoms(
    ...
    for colname in colnames:
        # determine if it is a compute, fix or custom property/atom (but not the quaternian)
        if (colname.startswith('f_') or colname.startswith('v_') or colname.startswith('d_') or colname.startswith('i_') or
            colname.startswith('i2_') or colname.startswith('d2_') or (colname.startswith('c_') and not colname.startswith('c_q['))):
